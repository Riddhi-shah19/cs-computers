      ...
      <section class="section-services container" id="services">
        ...
        <div class="grid grid--4-cols">
          <div class="services">
            ...
            />
            <p class="heading-tertiary">HARDWARE & SOFTWARE</p>
            <p class="service-content">
              ...
              technologies and deliver cost-effective <span id="firstTarget" class="read-more-text"> solutions.C S COMPUTERS,
          ...
          <div class="services">
            ...
            <p class="service-content">
              Over the years, c s computer and Teams has been laying the cable in industries
              hospitals Government sectors and as per Client Requirement , we are
